<?php
/**
 * @version		$Id: branches.php 461 2010-10-30 15:58:47Z louis $
...
/**
 * Methods supporting a list of branch records.
 *
 * @package		Joomla.Administrator
 * @subpackage	com_code
 */
class CodeModelBranches extends JModelList
{
	/**
	...
	protected function populateState()
	{
		...
		$projectId = $app->getUserStateFromRequest($this->context.'.filter.project_id', 'filter_project_id');
