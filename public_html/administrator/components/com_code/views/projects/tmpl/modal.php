<?php
/**
 * @version		$Id: modal.php 461 2010-10-30 15:58:47Z louis $
...
$function = JRequest::getVar('function', 'jSelectProject');
$listOrder	= $this->state->get('list.ordering');
$listDirn	= $this->state->get('list.direction');
?>
<form action="<?php echo JRoute::_('index.php?option=com_code&view=projects&layout=modal&tmpl=component&function='.$function);?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		...
		<?php foreach ($this->items as $i => $item) : ?>
			<tr class="row<?php echo $i % 2; ?>">
				<td>
					<a class="pointer" onclick="if (window.parent) window.parent.<?php echo $function;?>('<?php echo $item->project_id; ?>', '<?php echo $this->escape(addslashes($item->title)); ?>');">
